export default function WinDialog({ isOpen, onConfirm, enterGames, secretGame, difficulty }) {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50">
      <div
        ...
        <div className="flex flex-col items-center gap-2">
          <h2 className="text-2xl font-bold text-white">Победа!</h2>
          <p className="text-gray-400 text-sm">Ты угадал игру!</p>
        </div>
        ...
        <div className="flex gap-3">
          <button
            onClick={onConfirm}
            className="cursor-pointer flex-1 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 rounded-xl transition">
            Новая игра
          </button>
        </div>
